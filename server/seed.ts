...
const initialUsersData = [
  ...
  },
  {
    ...
    name: 'Future Tech',
    role: Role.Client,
    avatar: 'https://i.pravatar.cc/150?u=futuretech',
    status: UserStatus.Active,
...
const initialDailyStandupsData = [
  {
    ...
    yesterday: 'Finished homepage components',
    today: 'Start CMS integration',
    blockers: 'None',
  },
  {
    id: 2,
    employeeId: 3,
    date: yesterday.toISOString().split('T')[0],
    yesterday: 'Implemented user auth logic',
    today: 'Build core features module',
    blockers: 'API documentation is unclear',
  },
];
...
const initialNotificationsData = [
  {
    id: 1,
    message: 'Alice Johnson completed task "Create new design mockups".',
    createdAt: '2024-07-28T10:00:00Z',
    read: false,
  },
  {
    id: 2,
    message: 'New project "Marketing Campaign" has been created.',
    createdAt: '2024-07-27T14:30:00Z',
    read: true,
  },
  {
    id: 3,
    message: 'Bob Williams left a comment on task "Design database schema".',
  ...
  },
  {
    id: 4,
    message:
      'Project "Website Redesign" is now AT_RISK due to budget concerns.',
    createdAt: '2024-07-29T11:00:00Z',
    read: false,
  },
  {
    id: 5,
    message: 'Alice Johnson submitted a leave request.',
...
const initialBillingRecordsData = [
  ...
  },
  {
    id: 3,
    projectId: 2,
    description: 'Project Setup & Schema',
    hours: 40,
    rate: 55,
    total: 2200,
    date: '2024-07-20',
...
const initialProjectsData = [
  {
    ...
    progress: 75,
    description:
      'Complete overhaul of the main company website with a new design system and CMS.',
    ...
    comments: [
      {
        id: 1,
        authorId: 1,
        content: 'Great progress so far, team. Keep it up!',
        ...
        comments: [
          {
            id: 1,
            authorId: 3,
            content: 'Need to review the user table schema.',
            createdAt: '2024-07-28T11:00:00Z',
          },
        ],
        dueDate: '2024-07-22',
  ...
  },
  {
    ...
    tasks: [
      {
        id: 10,
        title: 'Finalize campaign goals',
        status: TaskStatus.Completed,
        loggedHours: 10,
        comments: [],
        dueDate: '2024-07-05',
        completedAt: '2024-07-04',
      },
      {
        id: 11,
  ...
  },
  {
    ...
    progress: 0,
    description:
      'Integrate third-party payment gateway API into the existing platform.',
    ...
    tasks: [
      ...
      {
        id: 14,
        title: 'Develop integration module',
        status: TaskStatus.ToDo,
        loggedHours: 0,
        comments: [],
        dueDate: '2024-09-20',
...
export const seedDatabase = async () => {
  ...
  if (!mongoUri) {
    console.error(
      'MongoDB URI not found for seeding. Please set MONGODB_URI in your environment variables.',
    );
    process.exit(1);
  }
