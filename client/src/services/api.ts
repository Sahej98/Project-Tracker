...
export const updateTask = (
  projectId: number,
  taskId: number,
  taskData: { status?: TaskStatus; loggedHours?: number },
) => api.put(`/projects/${projectId}/tasks/${taskId}`, taskData);

// --- Comments ---
export const addProjectComment = (
  projectId: number,
  commentData: { authorId: number; content: string },
...
export const markAllNotificationsAsRead = () => api.put('/notifications/read');
