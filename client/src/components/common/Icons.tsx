...
export const PauseCircleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  props,
) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
...
export const ArrowPathIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  ...
  <svg
    ...
    strokeLinejoin='round'
    {...props}>
    <path d='M21 12a9 9 0 1 1-9-9c2.52 0 4.88.99 6.6 2.6l-2.1 2.1' />
    <path d='M12 3v6h6' />
  </svg>
);
...
export const LogoIcon = (props: React.ImgHTMLAttributes<HTMLImageElement>) => (
  <img src='/icon.png' alt='Zenith' {...props} />
);
...
export const GanttChartIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  props,
) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
